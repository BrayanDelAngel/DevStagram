...
<div class="md:flex md:items-center">
    ...
    <form action="{{route('imagenes.store')}}" method="POST" enctype="multipart/form-data" id="dropzone" class="dropzone border-dashed border-4 w-full h-96 rounded flex flex-col justify-center items-center">
    @csrf 
    </form> 
    </div> 
